...
public class Roll6s implements RollDice {
    /**
     * The score is calculated by determining how many sixes are in the roll and multiplying by 6.
     * @param dice The dice in the roll.
     * @return The score of the dice if using the 6s.
     */
    @Override
    public int getScore(DiceSet dice) {
        return dice.getDie(6) * 6;
    }

    /**
     * The probability of rolling a one is calculated by determining what the probability of rolling a 6 with the
     * remaining dice is.
     ...
     * @return The probability of rolling a 6 for the remaining dice.
     */
    @Override
