 ...
 */
public class Roll5s implements RollDice {
    /**
     * The score is calculated by determining how many fives are in the roll and multiplying by 5.
     * @param dice The dice in the roll.
     * @return The score of the dice if using the 5s.
     */
    @Override
    public int getScore(DiceSet dice) {
        return dice.getDie(5) * 5;
    }

    /**
     * The probability of rolling a one is calculated by determining what the probability of rolling a 5 with the
     * remaining dice is.
     ...
     * @return The probability of rolling a 5 for the remaining dice.
     */
    @Override
