 ...
 */
public class Roll2s implements RollDice {
    /**
     * The score is calculated by determining how many twos are in the roll and multiplying by 2.
     * @param dice The dice in the roll.
     * @return The score of the dice if using the 2s.
     */
    @Override
    public int getScore(DiceSet dice) {
        return dice.getDie(2) * 2;
    }

    /**
     * The probability of rolling a one is calculated by determining what the probability of rolling a 2 with the
     * remaining dice is.
     ...
     * @return The probability of rolling a 2 for the remaining dice.
     */
    @Override
